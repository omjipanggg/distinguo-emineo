                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between">
                        ...
                        --}}
                            ...
                            --}}
                        {{--
                            @foreach ($project_numbers as $po)
                             <button type="button" onclick="filterHistory(event, '{{ $token }}', '{{ $po }}')" class="btn btn-primary px-3 rounded-0"><i class="bi bi-tag-fill me-2"></i>{{ $po }}</button>
                            @endforeach
                        </div>
                        @endif
                        --}}
