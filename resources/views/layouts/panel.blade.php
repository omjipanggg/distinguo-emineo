...
<body class="sb-nav-fixed">
    ...
    @include('components.modal-plain')

    @include('components.panel.header')

    <div id="layoutSidenav">

        @include('components.panel.accordion')
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid px-12">
                <div class="row">
                    <div class="col">
                        <div class="alert mb-4 alert-{{ session('variant') ?? 'success' }} alert-dismissible fade show" role="alert">
                            <i class="bi bi-{{ session('icon') ?? 'check-circle' }} me-3"></i>{{ session('message') ?? 'Information' }}
